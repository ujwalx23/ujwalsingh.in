  ...
  return (
    <section className="w-full fade-in-up stagger-5">
      ...
      <div className="glass-card p-4 sm:p-5">
        ...
        <div className="border-t border-primary/10 pt-3 sm:pt-4 mt-3 sm:mt-4">
          <div className="flex items-center justify-center gap-2 mb-2">
            <MessageCircle className="w-4 h-4 text-primary" />
            <span className="text-xs sm:text-sm font-medium gradient-text">Chat with Ujwal (AI)</span>
          </div>
          ...
          <a
            ...
            className="glass-button bg-primary/10 border-primary/30 hover:bg-primary/20 text-xs sm:text-sm py-2.5 sm:py-3"
          >
